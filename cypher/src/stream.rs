...
impl StreamCypher {
    ...
    pub fn set_counter(&mut self, num: u128) {
        self.counter = num;
    }
    ...
    pub fn encrypt_single_block(&self, input: &Block16) -> Block16 {
        ...
        let perm1: [usize; 16] = ithPermutation::<16>(p1n % fac16);
        let perm2: [usize; 16] = ithPermutation::<16>(p2n % fac16);
        let perm3: [usize; 16] = ithPermutation::<16>(p3n % fac16);
        let perm4: [usize; 16] = ithPermutation::<16>(p4n % fac16);
